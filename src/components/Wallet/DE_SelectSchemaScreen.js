...
const DE_SelectSchemaScreen = (props) => {
    ...
    const list = [
      {
        schema_title: 'fk2352sdsER34',
        version: '1.001',
        attribute: 'Vice President',
      },
      {
        schema_title: 'Schema Name2002',
        version: '2.0002',
        attribute: 'Vice President',
              ...
              <ListItem.Content>
                <View style={{flex:1, flexDirection:'row'}}>
                  ...
                  <ListItem.Content style={{flex:4}}>
                    <ListItem.Title >{item.schema_title}</ListItem.Title>
                  </ListItem.Content>
                </View>
              </ListItem.Content>
            </ListItem>
...
export default DE_SelectSchemaScreen;